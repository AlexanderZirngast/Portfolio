...
export default function AboutMe() {
  return (
    ...
    <div id="about-section" className="max-w-6xl px-4 py-6 mx-auto relative flex flex-col gap-4  justify-center scroll-mt-20 ">
        <ScrollFadeIn>
      ...
      <div className="flex justify-between">
        <div className="flex flex-1 flex-col justify-center gap-4 text-white">
          ...
          <Link className="bg-white text-black rounded-full p-2 w-fit hover:bg-gray-200 link-grow text-glow"  href={'#contact-section'}> Get in Touch</Link>
        </div>
